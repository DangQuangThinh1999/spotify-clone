...
const Sidebar = () => {
  ...
  return (
    <div className="text-gray-500 px-5 pt-5 pb-36 text-xs lg:text-sm border-r border-gray-900 h-screen  scrollbar-hide scrollbar hover:flow-y-auto sm:max-w-[12rem] lg:max-w-[15rem] hidden md:block">
